...
- (NSString *)statsString {
  ...
  [result
      appendString:[NSString stringWithFormat:systemStatsFormat, (long)ARDGetCpuUsagePercentage()]];
  ...
  [result appendString:[NSString stringWithFormat:videoSendFormat,
                                                  ...
                                                  _videoEncodeMs,
                                                  _videoSendCodec,
                                                  _framesEncoded - _oldFramesEncoded,
                                                  avgqp]];
  ...
  [result
      appendString:[NSString stringWithFormat:audioSendFormat, _audioSendBitrate, _audioSendCodec]];
