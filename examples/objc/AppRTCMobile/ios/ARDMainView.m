...
- (void)layoutSubviews {
  ...
  CGFloat callOptionsLabelTop = CGRectGetMaxY(_roomText.frame) + kCallControlMargin * 4;
  ...
  CGFloat loopbackModeLabelCenterX =
      CGRectGetMaxX(loopbackModeRect) + kCallControlMargin + _loopbackLabel.frame.size.width / 2;
  _loopbackLabel.center = CGPointMake(loopbackModeLabelCenterX, CGRectGetMidY(loopbackModeRect));
