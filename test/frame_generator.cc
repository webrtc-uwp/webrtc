...
class SquareGenerator : public FrameGenerator {
 public:
  SquareGenerator(int width, int height, int square_num) {
...
FrameGenerator::CreateSquareGenerator(int width, int height, int square_num) {
  return std::unique_ptr<FrameGenerator>(
      new SquareGenerator(width, height, square_num));
}
