...
class RtcEventLogEncoderLegacyTest : public testing::TestWithParam<int> {
 protected:
  RtcEventLogEncoderLegacyTest() : prng_(GetParam()) {}
  ...
  RtcEventLogEncoderLegacy encoder_;
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventAudioNetworkAdaptationBitrate) {
...
TEST_P(RtcEventLogEncoderLegacyTest,
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventAudioNetworkAdaptationPacketLoss) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventAudioNetworkAdaptationFec) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventAudioNetworkAdaptationDtx) {
  // The test might be trivially passing for one of the two boolean values, so
  // for safety's sake, we test both.
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventAudioNetworkAdaptationChannels) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventAudioPlayout) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventAudioReceiveStreamConfig) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventAudioSendStreamConfig) {
  auto stream_config = rtc::MakeUnique<rtclog::StreamConfig>();
  stream_config->local_ssrc = RandomSsrc();
  stream_config->rtp_extensions.push_back(
      RtpExtension(arbitrary_uri, RandomRtpExtensionId()));
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventBweUpdateDelayBased) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventBweUpdateLossBased) {
  const int32_t bitrate_bps = RandomBitrate();
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventLoggingStarted) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventLoggingStopped) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventProbeClusterCreated) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventProbeResultFailure) {
  const int id = RandomPositiveInt();
  constexpr ProbeFailureReason failure_reason =
      ProbeFailureReason::kInvalidSendReceiveRatio;  // ELAD!!!
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventProbeResultSuccess) {
  const int id = RandomPositiveInt();
  const int bitrate_bps = RandomBitrate();
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventRtcpPacketIncoming) {
  TestRtcEventRtcpPacket(PacketDirection::kIncomingPacket);
}

TEST_P(RtcEventLogEncoderLegacyTest, RtcEventRtcpPacketOutgoing) {
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventRtpPacketIncoming) {
  TestRtcEventRtpPacket(PacketDirection::kIncomingPacket);
}

TEST_P(RtcEventLogEncoderLegacyTest, RtcEventRtpPacketOutgoing) {
  TestRtcEventRtpPacket(PacketDirection::kOutgoingPacket);
}

TEST_P(RtcEventLogEncoderLegacyTest, RtcEventVideoReceiveStreamConfig) {
  auto stream_config = rtc::MakeUnique<rtclog::StreamConfig>();
...
TEST_P(RtcEventLogEncoderLegacyTest, RtcEventVideoSendStreamConfig) {
  auto stream_config = rtc::MakeUnique<rtclog::StreamConfig>();
  stream_config->local_ssrc = 4100;
