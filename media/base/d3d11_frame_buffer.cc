...
// After coming back a few months later I'm not sure why I wrote this...but
// probably because I420 fallback is mandatory and we need caller-allocated
// buffers, otherwise we get OOM instantly.
