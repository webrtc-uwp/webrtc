...
#define LOG_RTCERR0(func) LOG_RTCERR0_EX(func, GetLastEngineError())
#define LOG_RTCERR1(func, a1) LOG_RTCERR1_EX(func, a1, GetLastEngineError())
...
#define LOG_RTCERR0_EX(func, err) \
  LOG(LS_WARNING) << "" << #func << "() failed, err=" << err
#define LOG_RTCERR1_EX(func, a1, err) \
  LOG(LS_WARNING) << "" << #func << "(" << a1 << ") failed, err=" << err
