...
#define LOG_CHECK_LEVEL(sev) rtc::LogCheckLevel(rtc::sev)
#define LOG_CHECK_LEVEL_V(sev) rtc::LogCheckLevel(sev)
...
#define LOG_ERR_EX(sev, err) LOG(sev)
#define LOG_ERR(sev) LOG(sev)
