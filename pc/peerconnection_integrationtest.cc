...
TEST_F(PeerConnectionIntegrationTest, \
  ...
  ASSERT_GT(customizer1->allow_channel_data_cnt_, 0u);
  ASSERT_GT(customizer1->modify_cnt_, 0u);

  ASSERT_GT(customizer2->allow_channel_data_cnt_, 0u);
  ASSERT_GT(customizer2->modify_cnt_, 0u);
