...
TEST_F(PeerConnectionIntegrationTest, \
  ...
  ASSERT_GT(customizer1->allowchanneldata_cnt_, 0);
  ASSERT_GT(customizer1->maybemodifyoutgoingstunmessage_cnt_, 0);

  ASSERT_GT(customizer2->allowchanneldata_cnt_, 0);
  ASSERT_GT(customizer2->maybemodifyoutgoingstunmessage_cnt_, 0);
