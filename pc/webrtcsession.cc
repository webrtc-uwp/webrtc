...
static bool VerifyMediaDescriptions(const SessionDescription* answer,
...
bool WebRtcSession::UpdateSessionState(Action action,
...
bool WebRtcSession::PushdownMediaDescription(cricket::ContentAction action,
                                             cricket::ContentSource source,
                                             std::string* err) {
...
bool WebRtcSession::HasRtcpMuxEnabled(const cricket::ContentInfo* content) {
