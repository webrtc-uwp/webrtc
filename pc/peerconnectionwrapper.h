...
class PeerConnectionWrapper {
 public:
  // Constructs a PeerConnection from the given PeerConnectionFactory using the
  // specified parameters. If the PeerConnectio was not constructed
  // successfully, the result of calling |pc()| will be null and the wrapper
  // should not be used.
  // The internal MockPeerConnectionObserver will be hooked up to the created
  // PeerConnection and track information from the event callbacks.
