 ...
 protected:
  ...
  void CreateAnswerAsLocalDescription() {
    ...
    SessionDescriptionInterface* new_answer = webrtc::CreateSessionDescription(
        SessionDescriptionInterface::kAnswer, sdp, NULL);
  ...
  void CreatePrAnswerAsLocalDescription() {
    ...
    SessionDescriptionInterface* pr_answer = webrtc::CreateSessionDescription(
        SessionDescriptionInterface::kPrAnswer, sdp, NULL);
...
TEST_F(PeerConnectionInterfaceTest, TestRejectDataChannelInAnswer) {
  ...
  webrtc::JsepSessionDescription* answer =
      new webrtc::JsepSessionDescription(SessionDescriptionInterface::kAnswer);
  EXPECT_TRUE(answer->Initialize(sdp, NULL));
...
TEST_F(PeerConnectionInterfaceTest, ReceiveFireFoxOffer) {
  ...
  SessionDescriptionInterface* desc = webrtc::CreateSessionDescription(
      SessionDescriptionInterface::kOffer, webrtc::kFireFoxSdpOffer, nullptr);
...
TEST_F(PeerConnectionInterfaceTest, ReceiveUpdatedAudioOfferWithBadCodecs) {
  ...
  SessionDescriptionInterface* answer = webrtc::CreateSessionDescription(
      SessionDescriptionInterface::kAnswer, webrtc::kAudioSdp, nullptr);
  EXPECT_TRUE(DoSetSessionDescription(answer, false));

  SessionDescriptionInterface* updated_offer = webrtc::CreateSessionDescription(
      SessionDescriptionInterface::kOffer,
      webrtc::kAudioSdpWithUnsupportedCodecs, nullptr);
