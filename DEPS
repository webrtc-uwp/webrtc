...
vars = {
  ...
  'chromium_revision': 'eaccacb6302f7b0ea235fd7d1ff3aa7eaf8b20ef',
...
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '51861c31e5feb2058b71be86f5be61d373f6f139',
  'src/tools/gyp':
...
deps_os = {
  ...
  'ios': {
    'src/ios':
      Var('chromium_git') + '/chromium/src/ios' + '@' + '95cb9f60b16cb368b235d23053421d5795d96dc8',
  },
  'unix': {
    'src/third_party/lss':
      Var('chromium_git') + '/linux-syscall-support.git' + '@' + Var('lss_revision'),
