...
vars = {
  ...
  'chromium_revision': 'af26d5c2bf0f3d8c733426588aa5ed5b2d8af624',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '668c62d048afcc023b147a6afa3ca8eb0406a8d7',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '08147eda0da1a8d869389cc3776fab997f14182b',
  'src/tools/gyp':
...
deps_os = {
  ...
  'ios': {
    'src/ios':
      Var('chromium_git') + '/chromium/src/ios' + '@' + '754456f559d73a50ccd1336767aebad15c02d9b6',
  },
  'unix': {
    'src/third_party/lss':
