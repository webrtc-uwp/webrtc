...
vars = {
  ...
  'chromium_revision': '328e31aa4c19663b9e11cd07970e766c844881c1',
...
deps = {
  ...
  'src/base':
    Var('chromium_git') + '/chromium/src/base' + '@' + '399de75bd51e9c2f839a010a2cdacd1554e1be1b',
  'src/build':
    Var('chromium_git') + '/chromium/src/build' + '@' + 'b531a36dde620077e6062a05ef257687886dfe54',
  'src/buildtools':
    Var('chromium_git') + '/chromium/buildtools.git' + '@' + 'cbc33b9c0a9d1bb913895a4319a742c504a2d541',
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + 'd7f8718a82a3288a8a8850e1ff23d7b606bbca9a',
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '720c57070968b37c4a8a847bd248512033d4b816',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '2ce1e70459e319ee1ef25caa62c69754fd2d6ab7',
  'src/tools/gyp':
...
deps_os = {
  ...
  'ios': {
    'src/ios':
      Var('chromium_git') + '/chromium/src/ios' + '@' + '55bc2fb77e93e6d422b0f2528a720d2bda1249d6',
  },
  'unix': {
    'src/third_party/lss':
      Var('chromium_git') + '/linux-syscall-support.git' + '@' + Var('lss_revision'),
