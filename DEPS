...
vars = {
  ...
  'chromium_revision': '9d8037a736baeee658283be62e8f9d348ffac0a0',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '0597ce9bb6a8c180623a98ef13a9dc15a3c554de',
...
deps_os = {
  ...
  'ios': {
    'src/ios':
      Var('chromium_git') + '/chromium/src/ios' + '@' + '11c46cd3a9c75f9aba3032beb60806177630a45a',
  },
  'unix': {
    'src/third_party/lss':
      Var('chromium_git') + '/linux-syscall-support.git' + '@' + Var('lss_revision'),
