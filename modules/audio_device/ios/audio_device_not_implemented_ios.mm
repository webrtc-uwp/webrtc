...
int32_t AudioDeviceIOS::PlayoutBuffer(AudioDeviceModule::BufferType& type, uint16_t& sizeMS) const {
...
int32_t AudioDeviceIOS::SetPlayoutBuffer(const AudioDeviceModule::BufferType type,
                                         uint16_t sizeMS) {
  RTC_NOTREACHED() << "Not implemented";
  return -1;
}
