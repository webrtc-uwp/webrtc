...
#include "modules/audio_coding/codecs/builtin_audio_decoder_factory_internal.h"
...
#endif
#ifdef WEBRTC_CODEC_G722
      specs.push_back(AudioCodecSpec{{"G722", 8000, 1}, { 16000, 1, 64000 }});
#endif
#ifdef WEBRTC_CODEC_ILBC
      specs.push_back(AudioCodecSpec{{"ILBC", 8000, 1}, { 8000, 1, 13300 }});
#endif
      specs.push_back(AudioCodecSpec{{"PCMU", 8000, 1}, {8000, 1, 64000}});
      specs.push_back(AudioCodecSpec{{"PCMA", 8000, 1}, {8000, 1, 64000}});
      return specs;
    }();
    return specs;
  }
