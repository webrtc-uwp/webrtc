...
TEST(AudioCodingModuleTest, TestAllCodecs) {
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_allcodecs_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestEncodeDecode) {
  ...
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_encodedecode_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestRedFec) {
  ...
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_fec_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestIsac) {
  ...
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_isac_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TwoWayCommunication) {
  ...
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_twowaycom_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestStereo) {
  ...
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_stereo_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestWebRtcVadDtx) {
  ...
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_vaddtx_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestOpusDtx) {
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_opusdtx_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestOpus) {
  ...
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_opus_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestPacketLoss) {
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_packetloss_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestPacketLossBurst) {
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_packetloss_burst_trace.txt").c_str());
...
TEST(AudioCodingModuleTest, TestAPI) {
  Trace::CreateTrace();
  Trace::SetTraceFile(
      (webrtc::test::OutputPath() + "acm_apitest_trace.txt").c_str());
