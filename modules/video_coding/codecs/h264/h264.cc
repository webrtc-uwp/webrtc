...
std::vector<SdpVideoFormat> SupportedH264Codecs() {
  ...
  // We only support encoding Constrained Baseline Profile, but we support
  // decoding the other profiles listed here. We can correctly support all these
  // profiles in SDP, because it's allowed to encode and send CBP even though
  // one of the other profiles here are negotiated.
  return {CreateH264Format(H264::kProfileConstrainedHigh, H264::kLevel3_1),
          CreateH264Format(H264::kProfileHigh, H264::kLevel3_1),
          CreateH264Format(H264::kProfileMain, H264::kLevel3_1),
