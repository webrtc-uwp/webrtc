...
BOOL CALLBACK TopWindowVerifier(HWND hwnd, LPARAM param) {
  ...
  DesktopRect enumerated_desktop_rect =
      DesktopRect::MakeLTRB(enumerated_rect.left, enumerated_rect.top,
                            enumerated_rect.right, enumerated_rect.bottom);
...
bool CroppingWindowCapturerWin::ShouldUseScreenCapturer() {
  ...
  if (region_type == SIMPLEREGION) {
    ...
    DesktopRect rgn_rect =
        DesktopRect::MakeLTRB(region_rect.left, region_rect.top,
