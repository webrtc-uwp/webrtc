...
bool RtpReceiverImpl::IncomingRtpPacket(const RTPHeader& rtp_header,
...

  {
    ...
    // TODO(nisse): Do not rely on InOrder for recovered packets, when
    // packet is passed as RtpPacketReceived and that information is
    // available. We should ideally never record timestamps for
    // retransmitted or recovered packets.
