...
- (void)testCandidate {
  ...
  RTCIceCandidate *candidate =
      [[RTCIceCandidate alloc] initWithSdp:sdp sdpMLineIndex:0 sdpMid:@"audio"];
...
- (void)testInitFromNativeCandidate {
  ...
  RTCIceCandidate *iceCandidate = [[RTCIceCandidate alloc] initWithNativeCandidate:nativeCandidate];
