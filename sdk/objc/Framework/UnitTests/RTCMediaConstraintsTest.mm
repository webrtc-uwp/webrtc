...
- (void)testMediaConstraints {
  ...
  webrtc::MediaConstraintsInterface::Constraints nativeOptional = nativeConstraints->GetOptional();
  [self expectConstraints:optional inNativeConstraints:nativeOptional];
}

- (void)expectConstraints:(NSDictionary *)constraints
      inNativeConstraints:(webrtc::MediaConstraintsInterface::Constraints)nativeConstraints {
