...
- (void)testOneURLServer {
  RTCIceServer *server = [[RTCIceServer alloc] initWithURLStrings:@[ @"stun:stun1.example.net" ]];
...
- (void)testInitFromNativeServer {
  ...
  RTCIceServer *iceServer = [[RTCIceServer alloc] initWithNativeServer:nativeServer];
