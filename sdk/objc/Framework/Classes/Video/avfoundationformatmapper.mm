...
// stack imposes.
static NSArray<AVCaptureDeviceFormat*>* GetEligibleDeviceFormats(const AVCaptureDevice* device,
                                                                 int supportedFps) {
...
static AVCaptureDeviceFormat* GetDeviceFormatForVideoFormat(
    const AVCaptureDevice* device, const cricket::VideoFormat& videoFormat) {
...
std::set<cricket::VideoFormat> GetSupportedVideoFormatsForDevice(AVCaptureDevice* device) {
  ...
  for (AVCaptureDeviceFormat* deviceFormat in eligibleFormats) {
    ...
    cricket::VideoFormat format =
        cricket::VideoFormat(dimension.width,
                             dimension.height,
...
bool SetFormatForCaptureDevice(AVCaptureDevice* device,
  ...
  AVCaptureDeviceFormat* deviceFormat = GetDeviceFormatForVideoFormat(device, format);
