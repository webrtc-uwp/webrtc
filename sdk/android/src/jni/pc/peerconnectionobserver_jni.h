...
class PeerConnectionObserverJni : public PeerConnectionObserver,
 ...
 private:
  ...
  void AddNativeTrackToJavaStream(rtc::scoped_refptr<AudioTrackInterface> track,
                                  jobject j_stream);
  void AddNativeTrackToJavaStream(rtc::scoped_refptr<VideoTrackInterface> track,
                                  jobject j_stream);
