...
public class SurfaceVideoViewOnMeasureTest {
  ...
  public void testNoFrame() {
    ...
    final SurfaceVideoRenderer surfaceVideoRenderer =
        new SurfaceVideoRenderer(surfaceVideoView.getResourceName());
    final String frameDimensions = "null";

    // Test behaviour before SurfaceVideoView.init() is called.
    ...
    // Test behaviour after SurfaceVideoView.init() is called, but still no frame.
