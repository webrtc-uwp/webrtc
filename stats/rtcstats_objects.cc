...
WEBRTC_RTCSTATS_IMPL(RTCCertificateStats,
                     RTCStats,
                     "certificate",
                     &fingerprint,
...
WEBRTC_RTCSTATS_IMPL(RTCCodecStats,
                     RTCStats,
                     "codec",
                     &payload_type,
                     &mime_type,
...
WEBRTC_RTCSTATS_IMPL(RTCDataChannelStats,
                     RTCStats,
                     "data-channel",
                     &label,
                     &protocol,
...
WEBRTC_RTCSTATS_IMPL(RTCIceCandidatePairStats,
                     RTCStats,
                     "candidate-pair",
                     &transport_id,
                     &local_candidate_id,
...
WEBRTC_RTCSTATS_IMPL(RTCIceCandidateStats,
                     RTCStats,
                     "ice-candidate",
                     &transport_id,
                     &is_remote,
...
WEBRTC_RTCSTATS_IMPL(RTCMediaStreamStats,
                     RTCStats,
                     "stream",
                     &stream_identifier,
                     &track_ids);
...
WEBRTC_RTCSTATS_IMPL(RTCPeerConnectionStats,
                     RTCStats,
                     "peer-connection",
...
WEBRTC_RTCSTATS_IMPL(RTCOutboundRTPStreamStats,
                     RTCRTPStreamStats,
                     "outbound-rtp",
                     &packets_sent,
                     &bytes_sent,
...
WEBRTC_RTCSTATS_IMPL(RTCTransportStats,
                     RTCStats,
                     "transport",
                     &bytes_sent,
                     &bytes_received,
