...
void ReceiveStatisticsProxy::OnRenderedFrame(const VideoFrame& frame) {
  ...
  TRACE_EVENT_INSTANT1("webrtc_stats", "WebRTC.Video.OnRenderedFrame", "ssrc",
                       stats_.ssrc);
}
