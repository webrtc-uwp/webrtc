...
void SendStatisticsProxy::OnEncodedFrameTimeMeasured(
  ...
  TRACE_EVENT_INSTANT2("webrtc_stats", "WebRTC.Video.EncodeTimeInMs",
                       "encode_time_ms", stats_.avg_encode_time_ms, "ssrc",
                       rtp_config_.ssrcs[0]);
...
void SendStatisticsProxy::OnSendEncodedImage(
  ...
  TRACE_EVENT_INSTANT2("webrtc_stats", "WebRTC.Video.SentWidthInPixels",
                       "frame_width", encoded_image._encodedWidth, "ssrc",
                       ssrc);
  TRACE_EVENT_INSTANT2("webrtc_stats", "WebRTC.Video.SentHeightInPixels",
                       "frame_height", encoded_image._encodedHeight, "ssrc",
                       ssrc);
}
...
void SendStatisticsProxy::OnIncomingFrame(int width, int height) {
  ...
  TRACE_EVENT_INSTANT2(
      "webrtc_stats", "WebRTC.Video.InputFrameRate", "frame_rate",
      round(uma_container_->input_frame_rate_tracker_.ComputeRate()), "ssrc",
      rtp_config_.ssrcs[0]);
}
...
void SendStatisticsProxy::RtcpPacketTypesCounterUpdated(
  ...
  TRACE_EVENT_INSTANT2("webrtc_stats", "WebRTC.Video.FirPacketsReceived",
                       "fir_packets_received", packet_counter.fir_packets,
                       "ssrc", ssrc);
  TRACE_EVENT_INSTANT2("webrtc_stats", "WebRTC.Video.NackPacketsReceived",
                       "nack_packets_received", packet_counter.nack_packets,
                       "ssrc", ssrc);
  TRACE_EVENT_INSTANT2("webrtc_stats", "WebRTC.Video.PliPacketsReceived",
                       "pli_packets_received", packet_counter.pli_packets,
                       "ssrc", ssrc);
}
...
void SendStatisticsProxy::StatisticsUpdated(const RtcpStatistics& statistics,
  ...
  TRACE_EVENT_INSTANT2("webrtc_stats", "WebRTC.Video.SentPacketsLost",
                       "packets_lost", statistics.cumulative_lost, "ssrc",
                       ssrc);
}
...
void SendStatisticsProxy::DataCountersUpdated(
  ...
  TRACE_EVENT_INSTANT2("webrtc_stats", "WebRTC.Video.SentPackets",
                       "packets_sent", counters.transmitted.packets, "ssrc",
                       ssrc);
}
