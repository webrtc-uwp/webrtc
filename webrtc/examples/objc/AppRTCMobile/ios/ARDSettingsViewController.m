...
- (UITableViewCell *)audioSettingsTableViewCellForTableView:(UITableView *)tableView
  ...
  cell.textLabel.text = [self labelForAudioSetting:indexPath.row];
  UISwitch *switchView = (UISwitch *)cell.accessoryView;
  switchView.on = [self valueForAudioSetting:indexPath.row];

  return cell;
}

- (NSString *)labelForAudioSetting:(int)setting {
  switch (setting) {
...
- (BOOL)valueForAudioSetting:(int)setting {
  switch (setting) {
    case ARDAudioSettingsAudioOnly:
