...
- (BOOL)cropAndScaleTo:(CVPixelBufferRef)outputPixelBuffer withTempBuffer:(void*)tmpBufferVoid {
  std::vector<uint8_t>* tmpBuffer = static_cast<std::vector<uint8_t>*>(tmpBufferVoid);
...
- (id<RTCI420Buffer>)toI420 {
  ...
  return (RTCI420Buffer*)i420Buffer;
}
