...
class HardwareVideoDecoder implements VideoDecoder {
  ...
  // Prevents the decoder from being released before all the output frames have been released.
  ...
  private void releaseCodecOnOutputThread() {
    ...
    waitOutputBufferReleasedOnOutputThread();
    try {
      codec.stop();
    } catch (Exception e) {
  ...
  private void waitOutputBufferReleasedOnOutputThread() {
