...
class HardwareVideoEncoder implements VideoEncoder {
  ...
  private static final Set<Integer> SUPPORTED_COLOR_FORMATS =
      new HashSet<>(Arrays.asList(MediaCodecInfo.CodecCapabilities.COLOR_FormatYUV420Planar,
  ...
  public void encode(VideoFrame videoFrame, EncodeInfo encodeInfo) {
    ...
    switch (colorFormat) {
      ...
      default:
        if (SUPPORTED_COLOR_FORMATS.contains(colorFormat)) {
          Logging.e(TAG, "BUG: SUPPORTED_COLOR_FORMATS out-of-sync with encode switch");
        }
