...
bool MediaCodecVideoEncoder::FillInputBuffer(JNIEnv* jni,
                                             ...
                                             int crop_width,
                                             int crop_height) {
  RTC_DCHECK_EQ(width_, crop_width);
  RTC_DCHECK_EQ(height_, crop_height);
...
(JNIEnv* jni,
 ...
 jint crop_height) {
  uint8_t* buffer_y =
      static_cast<uint8_t*>(jni->GetDirectBufferAddress(j_buffer_y)) + offset_y;
  uint8_t* buffer_u =
      static_cast<uint8_t*>(jni->GetDirectBufferAddress(j_buffer_u)) + offset_u;
  uint8_t* buffer_v =
      static_cast<uint8_t*>(jni->GetDirectBufferAddress(j_buffer_v)) + offset_v;
