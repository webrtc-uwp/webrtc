...
public final class HardwareVideoDecoderTest {
  ...
  public void testInitialize() {
    ...
    VideoDecoder decoder = decoderFactory.createDecoder(supportedCodecs[0]);
  ...
  public void testDecode() throws InterruptedException {
    ...
    assertEquals(frame.getBuffer().getWidth(), 640);
    assertEquals(frame.getBuffer().getHeight(), 480);
