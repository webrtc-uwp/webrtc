...
public class RendererCommon {
  ...
  public static android.graphics.Matrix convertMatrixToAndroidGraphicsMatrix(float[] matrix4x4) {
    // clang-format off
    float[] values = {
        matrix4x4[0 * 4 + 0], matrix4x4[0 * 4 + 1], matrix4x4[0 * 4 + 3],
        matrix4x4[1 * 4 + 0], matrix4x4[1 * 4 + 1], matrix4x4[1 * 4 + 3],
        matrix4x4[3 * 4 + 0], matrix4x4[3 * 4 + 1], matrix4x4[3 * 4 + 3],
    };
    // clang-format on
  ...
  public static float[] convertMatrixFromAndroidGraphicsMatrix(android.graphics.Matrix matrix) {
    ...
    // clang-format off
    float[] matrix4x4 = {
        values[0 * 3 + 0],  values[0 * 3 + 1], 0,  values[0 * 3 + 2],
        values[1 * 3 + 0],  values[1 * 3 + 1], 0,  values[1 * 3 + 2],
        0,                  0,                 1,  0,
        values[2 * 3 + 0],  values[2 * 3 + 1], 0,  values[2 * 3 + 2],
    };
    // clang-format on
    return matrix4x4;
  }
