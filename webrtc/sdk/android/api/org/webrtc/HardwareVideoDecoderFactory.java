...
public class HardwareVideoDecoderFactory implements VideoDecoderFactory {
  ...
  private static final int[] SUPPORTED_COLOR_FORMATS = new int[] {
  ...
  @Override
  public VideoDecoder createDecoder(String name) {
    VideoCodecType type = VideoCodecType.valueOf(name);
    ...
    return new HardwareVideoDecoder(info.getName(), type,
        MediaCodecUtils.selectColorFormat(SUPPORTED_COLOR_FORMATS, capabilities));
  }
