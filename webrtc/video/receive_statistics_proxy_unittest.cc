...
TEST_F(ReceiveStatisticsProxyTest, PacketLossHistogramIsUpdated) {
  ...
  rtcp_stats1.cumulative_packets_lost = kCumLost1;
  ...
  rtcp_stats2.cumulative_packets_lost = kCumLost2;
...
TEST_F(ReceiveStatisticsProxyTest,
  ...
  RtcpStatistics rtcp_stats1;
  rtcp_stats1.cumulative_packets_lost = 1;
