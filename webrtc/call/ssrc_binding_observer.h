...
// be learned on the fly by correlating packet SSRCs with included RTP extension
// headers like MID and RSID.
...
class SsrcBindingObserver {
 public:
  ...
  virtual void OnBindingFromRsid(const std::string& rsid, uint32_t ssrc) = 0;
};
