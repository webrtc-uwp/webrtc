...
#ifndef WEBRTC_TEST_CHANNEL_TRANSPORT_UDP_SOCKET_WINUWP_H_
#define WEBRTC_TEST_CHANNEL_TRANSPORT_UDP_SOCKET_WINUWP_H_
...
class UdpSocketWinUWP : public UdpSocketWrapper
{
public:
    UdpSocketWinUWP(const int32_t id, UdpSocketManager* mgr,
                   bool ipV6Enable = false);

    virtual ~UdpSocketWinUWP();
