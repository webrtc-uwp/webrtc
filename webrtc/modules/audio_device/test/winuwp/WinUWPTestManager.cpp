...
WinUWPTestManager::WinUWPTestManager() :
_audioDevice(NULL),
...
int32_t WinUWPTestManager::SelectRecordingDevice()
{
...
int32_t WinUWPTestManager::SelectPlayoutDevice()
{
...
int32_t WinUWPTestManager::Init()
{

  Trace::CreateTrace();
  Trace::SetTraceFile((test::OutputPath() + "audio_device_test_winuwp_trace.txt").c_str());
...
int32_t WinUWPTestManager::TestDeviceEnumeration()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestDeviceSelection()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestAudioTransport()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestLoopback()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestMicrophoneAGC()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestSpeakerVolume()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestMicrophoneVolume()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestSpeakerMute()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestMicrophoneMute()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestDeviceRemoval()
{
  TEST_LOG("\n=======================================\n");
...
int32_t WinUWPTestManager::TestExtra()
{
  TEST_LOG("\n=======================================\n");
  TEST_LOG(" Extra test:\n");
  TEST_LOG("=======================================\n");
