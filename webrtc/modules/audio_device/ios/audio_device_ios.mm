...
int32_t AudioDeviceIOS::StopPlayout() {
  ...
  // A value of 100000.0 should be seen as "infinity" in this context.
  double average_time_between_playout_glitches = 100000.0;
  // Derive average time between audio glitches on the playout side.
  if (num_detected_playout_glitches_ > 0) {
    ...
    average_time_between_playout_glitches =
        playout_duration_seconds / num_detected_playout_glitches_;
  }
  RTC_HISTOGRAM_COUNTS_100000("WebRTC.Audio.AverageTimeBetweenPlayoutGlitches",
      average_time_between_playout_glitches);
  RTCLog(@"Average time between between playout glitches: %f",
         average_time_between_playout_glitches);
  return 0;
}
