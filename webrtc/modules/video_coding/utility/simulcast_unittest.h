...
#ifndef WEBRTC_MODULES_VIDEO_CODING_UTILITY_SIMULCAST_UNITTEST_H_
#define WEBRTC_MODULES_VIDEO_CODING_UTILITY_SIMULCAST_UNITTEST_H_
...
class TestSimulcast : public ::testing::Test {
 public:
  TestSimulcast(VideoEncoder* encoder,
                VideoDecoder* decoder,
                VideoCodecType codec_type)
      : encoder_(encoder), decoder_(decoder), codec_type_(codec_type) {}
  ...
  static void DefaultSettings(VideoCodec* settings,
    ...
    if (codec_type == kVideoCodecVP8) {
      ...
      ConfigureStream(kDefaultWidth / 4, kDefaultHeight / 4, kMaxBitrates[0],
                      kMinBitrates[0], kTargetBitrates[0],
                      &settings->simulcastStream[0], -1);
      ConfigureStream(kDefaultWidth / 2, kDefaultHeight / 2, kMaxBitrates[1],
                      kMinBitrates[1], kTargetBitrates[1],
                      &settings->simulcastStream[1], -1);
      ConfigureStream(kDefaultWidth, kDefaultHeight, kMaxBitrates[2],
                      kMinBitrates[2], kTargetBitrates[2],
                      &settings->simulcastStream[2], -1);
...
#endif  // WEBRTC_MODULES_VIDEO_CODING_UTILITY_SIMULCAST_UNITTEST_H_
