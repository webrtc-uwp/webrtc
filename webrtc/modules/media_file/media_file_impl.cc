                                        ...
                                        size_t& dataLengthInBytes)
{
    LOG(LS_INFO) << "MediaFileImpl::PlayoutData(buffer= "
                 << buffer << ", bufLen= " << dataLengthInBytes << ")";
...
{
    LOG(LS_INFO)
        << "MediaFileImpl::PlayoutStereoData(Left = " << bufferLeft
        << ", Right = " << bufferRight << ", Len= " << dataLengthInBytes << ")";
...
{
    LOG(LS_INFO) << "MediaFile::IncomingData(buffer= " << buffer << ", bufLen= "
                 << bufferLengthInBytes << ")";
