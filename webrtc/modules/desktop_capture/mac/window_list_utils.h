...
// Iterates all on-screen windows in decreased z-order and sends them one-by-one
// to |on_window| function. If |on_window| returns false, this function returns
// immediately. This function returns false if native APIs failed. Menus, dock
// minimized windows and any windows which do not have a valid window id or
