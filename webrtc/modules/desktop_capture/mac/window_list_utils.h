...
// Iterates all on-screen windows in z-order and sends them one-by-one to
// |on_window| function. If |on_window| returns false, this function returns
// immediately. This function returns false if native APIs failed. This function
// always ignores menus, dock and any windows which do not have a valid window
// id or title.
