...
// Returns the id of the root visible window under |point|. This function
// returns kNullWindowId if no window is under |point| and the platform does not
// have "root window" concept, i.e. the visible area under |point| is the
// desktop.
