 ...
 public:
  ...
  class Callback {
   public:
    ...
    // position on the system. The top-left monitor is guaranteed to always
    // start from (0, 0).
    // TODO(zijiehe): Make this function pure virtual after Chromium changes.
    // TODO(zijiehe): Current this overload works "correctly" only when
    // capturing mouse cursor against fullscreen.
