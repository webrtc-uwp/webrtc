...
void P2PTransportChannel::SetIceConfig(const IceConfig& config) {
  ...
  if (config.regather_on_all_networks_interval_range != 0) {
    config_.regather_on_all_networks_interval_range =
        config.regather_on_all_networks_interval_range;
    LOG(LS_INFO) << "Set regather_on_all_networks_interval_range to "
                 << config_.regather_on_all_networks_interval_range;
  }
...
int P2PTransportChannel::SampleRegatherOnAllNetworksDelay() {
  int a = *config_.regather_on_all_networks_interval;
  int b = config_.regather_on_all_networks_interval_range;
  std::uniform_int_distribution<> dist(a - b, a + b);
